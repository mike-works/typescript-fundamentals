...
/**
 * (10) Tuple values ALWAYS require type annotations (  : [number, number] )
 */
...
function hasEmail(val: any): val is HasEmail {
  return val && typeof val.email === 'string';
}
